...
//        }
    ...
    public void setText(CharSequence text, BufferType type) {
        ...
        if(type != BufferType.SPANNABLE) {
            contextString = text.toString();
        }
//        String textsourece = TextJustification.justifyword(text.toString(), this, getMeasuredWidth());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if(event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (layout!=null){
                ...
                final SpannableString sp = new SpannableString(contextString);
                Log.i("index", "" +contextString);
                ...
                sp.setSpan(new TagImageSpan(0, 0), characterOffset + 1, temp,
                        Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

                Log.i("index", "" +characterOffset + " - " + temp);
//                final SpannableString headstring = new SpannableString("hhhhhhhhh");
//                headstring.setSpan(new TagImageSpan(0, 0), 2, 4,
//                        Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//                tvHead.setText(headstring);
//                tvContent.setText(contextString);
